...
from main.Discord_Scraper_master.SimpleRequests import SimpleRequest
from main.Discord_Scraper_master.SimpleRequests.SimpleRequest import error
...
# configdata = {
#       "token": "MzQ2MzU2OTg3MDE0OTM4NjM0.XqxMVQ.jKGcLrCrrQbZdhN-WiaH00bKOhA",
#       "agent": "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) discord/0.0.305 Chrome/69.0.3497.128 Electron/4.0.8 Safari/537.36",
#       "buffer": 1048576,
#
#       "query": {
#         "images": 'true',
...
class Discord:
    ...
    def create_folders(server, channel):
        ...
        folder = path.join(getcwd(), 'Bot Scrapes', server, channel)
    ...
    def insert_text(server, channel, message):
        ...
        dbdir = path.join(getcwd(), 'Bot Scrapes')
